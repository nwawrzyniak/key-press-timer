...
import com.nwawsoft.kpt.BuildData;
import com.nwawsoft.util.HTMLTagger;
...
public class AboutFrame extends JFrame {
  ...
  private void init() {
    ...
    JLabel labelAboutText2 = new JLabel(HTMLTagger.toHTML("written by Nico Wawrzyniak"), SwingConstants.CENTER);
